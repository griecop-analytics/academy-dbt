with
    ...
    , join_tables as (
        ...
        left join int_persons_addresses 
            on stg_sales_persons.sales_person_id = int_persons_addresses.person_id
        left join stg_sales_territories 
            on stg_sales_persons.territory_id = stg_sales_territories.territory_id
    )
